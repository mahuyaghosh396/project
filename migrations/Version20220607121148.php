 ...
 */
final class Version20220607121148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE web_notice (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(300) NOT NULL, notice_from DATETIME NOT NULL, notice_to DATETIME NOT NULL, status ENUM(\'Active\', \'Deleted\'), created DATETIME NOT NULL, updated DATETIME NOT NULL, file VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
